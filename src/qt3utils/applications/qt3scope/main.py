...
DEFAULT_CONFIG_FILE = 'qt3scope_snspd.yaml'
...
class ScopeApplication:
    ...
    def __init__(
        ...
        signal_source_override : str, optional
            If set ('counter', 'photodiode', or 'snspd'), selects the active reader instead of YAML.
        '''
    ...
    def _sync_signal_source_gui(self) -> None:
        ...
        if self._reader_snspd is None:
            self.view.control_panel.snspd_radio.config(state='disabled')
