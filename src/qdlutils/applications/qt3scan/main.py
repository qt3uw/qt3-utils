...
from qdlutils.hardware.nidaq.digitaloutputs.flipper_mount import FlipperMountController, FlipperMountError
...
CONFIG_FILE_MIRROR_STATE = 'MirrorController'
...
class MainTkApplication:
    ...
    def _scan_thread_function(self, xmin: float, xmax: float, ymin: float, ymax: float, step_size: float) -> None:
        ...
        try:
            ...
            #self.application_controller.set_mirros()
